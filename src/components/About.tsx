        ...
        <div className="mt-16 flex justify-center">
          <div className="stats grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="stat text-center">
              <div className="text-4xl font-bold text-purple mb-2">3+</div>
              <div className="text-sm opacity-80">Years Experience</div>
            </div>
            <div className="stat text-center">
              <div className="text-4xl font-bold text-purple mb-2">50+</div>
              <div className="text-sm opacity-80">Projects Completed</div>
            </div>
            <div className="stat text-center">
              <div className="text-4xl font-bold text-purple mb-2">20+</div>
              <div className="text-sm opacity-80">Happy Clients</div>
            </div>
            <div className="stat text-center">
              <div className="text-4xl font-bold text-purple mb-2">1000+</div>
